...
import { getSuggestedEditById } from 'apiSdk/suggested-edits';
...
function SuggestedEditViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Suggested Edit Detail View
          </Text>
          {hasAccess('suggested_edit', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/suggested-edits/edit/${data?.id}`} passHref legacyBehavior>
              <Button
