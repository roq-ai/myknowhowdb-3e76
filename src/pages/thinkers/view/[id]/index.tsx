...
import { getThinkerById } from 'apiSdk/thinkers';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('thinker', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/thinkers/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('resource', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/resources/create?thinker_id=${data?.id}`}>
